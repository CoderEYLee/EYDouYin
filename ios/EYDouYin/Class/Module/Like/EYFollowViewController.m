...
#import "EYFollowListViewController.h"
#import "EYFollowFriendViewController.h"

@interface EYFollowViewController () <UIScrollViewDelegate>
...
@implementation EYFollowViewController
...
- (void)setupUI {
    ...
    //2.1 关注列表
    EYFollowListViewController *followListViewController = [[EYFollowListViewController alloc] init];
    [self addChildViewController:followListViewController];
    followListViewController.view.frame = CGRectMake(0, 0, EYScreenWidth, scrollView.mj_h);
    [scrollView addSubview:followListViewController.view];
    
    //2.2 好友列表
    EYFollowFriendViewController *friendListViewController = [[EYFollowFriendViewController alloc] init];
    [self addChildViewController:friendListViewController];
    friendListViewController.view.frame = CGRectMake(EYScreenWidth, 0, EYScreenWidth, scrollView.mj_h);
    [scrollView addSubview:friendListViewController.view];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    // 滚定条
    self.lineLabel.mj_x = 5 + (scrollView.contentOffset.x / EYScreenWidth) * 50;
}

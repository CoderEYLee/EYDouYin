...
#import "EYPhotoProgressView.h"
#import "UIImageView+WebCache.h"

@interface EYPhotoViewerController () <UIScrollViewDelegate>

@end

@implementation EYPhotoViewerController {
    UIScrollView *_scrollView;
    UIImageView *_imageView;
    EYPhotoProgressView *_progressView;
...
- (void)prepareUI {
    ...
    _progressView = [[EYPhotoProgressView alloc] initWithFrame:CGRectMake(0, 0, 80, 80)];

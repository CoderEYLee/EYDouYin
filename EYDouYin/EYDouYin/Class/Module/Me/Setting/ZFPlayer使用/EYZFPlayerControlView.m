...
static const CGFloat EYZFPlayerAnimationTimeInterval              = 0.5f;
static const CGFloat EYZFPlayerControlViewAutoFadeOutTimeInterval = 0.5f;

@interface EYZFPlayerControlView ()
<ZFSliderViewDelegate>
/// 竖屏控制层的View
@property (nonatomic, strong) EYZFPortraitControlView *portraitControlView;
/// 横屏控制层的View
...
- (void)autoFadeOutControlView {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(EYZFPlayerAnimationTimeInterval * NSEC_PER_SEC)), dispatch_get_main_queue(),self.afterBlock);
}
...
- (void)hideControlViewWithAnimated:(BOOL)animated {
    [UIView animateWithDuration:animated?EYZFPlayerControlViewAutoFadeOutTimeInterval:0 animations:^{
...
- (EYZFPortraitControlView *)portraitControlView {
    if (!_portraitControlView) {
        @weakify(self)
        _portraitControlView = [[EYZFPortraitControlView alloc] init];
